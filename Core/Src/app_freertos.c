...
/* Definitions for deadReckoning */
osThreadId_t deadReckoningHandle;
const osThreadAttr_t deadReckoning_attributes = {
  .name = "deadReckoning",
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* creation of lorawan */
  lorawanHandle = osThreadNew(startLorawan, NULL, &lorawan_attributes);

  /* creation of deadReckoning */
  deadReckoningHandle = osThreadNew(StartDeadReckoning, NULL, &deadReckoning_attributes);
